...
def get_sub_links(main_page_link):
    ...
    # print(soup)
    divs = soup.find("div",{"class":"col-md-12 col-lg-8 col-xl-8 col-xxl-9 category"})
    ...
    for i in divs.find_all("a"):
        ...
        # complete_url = "https://www.bd-pratidin.com/" + j[0:len(j)]
        print("https://www.bd-pratidin.com/" + str(j))
        all_unit_link.append(["https://www.bd-pratidin.com/" + str(j)])
        #print(all_unit_link)
